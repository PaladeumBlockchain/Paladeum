...
class TestPaladeumCli(PaladeumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `paladeum-cli getinfo`")
        ...
        self.log.info("Compare responses from `paladeum-cli -getinfo` and the RPCs data is retrieved from.")
