...
class TestAkilaCli(AkilaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `akila-cli getinfo`")
        ...
        self.log.info("Compare responses from `akila-cli -getinfo` and the RPCs data is retrieved from.")
