...
class BIP66Test(AkilaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # akilad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and akilad produces more specific reject
            # reasons.
