...
class BIP66Test(PaladeumTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # paladeumd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and paladeumd produces more specific reject
            # reasons.
