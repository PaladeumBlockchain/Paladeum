...
class BIP66Test(YonaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # yonad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and yonad produces more specific reject
            # reasons.
