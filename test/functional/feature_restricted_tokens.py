...
class RestrictedTokensTest(YonaTestFramework):
    ...
    def activate_restricted_tokens(self):
        self.log.info("Generating YONA and activating restricted tokens...")
        n0 = self.nodes[0]
        n0.generate(432)
        self.sync_all()
        n1 = self.nodes[1]
    ...
    def issuerestrictedtoken(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.issuerestrictedtoken, token_name, qty, verifier, "garbageaddress")
    ...
    def issuerestrictedtoken_full(self):
        ...
        # valid params
        assert_raises_rpc_error(None, "Invalid Yona address", n0.issuerestrictedtoken, token_name, qty, verifier, to_address, "garbagechangeaddress")
    ...
    def reissuerestrictedtoken_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.reissuerestrictedtoken, token_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona address", n0.reissuerestrictedtoken, token_name, qty, to_address, change_verifier, verifier, "garbagechangeaddress")
    ...
    def issue_qualifier_token_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.issuequalifiertoken, token_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona address", n0.issuequalifiertoken, token_name, qty, to_address, "gargabechangeaddress")
    ...
    def transferqualifier(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.transferqualifier, token_name, 1, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona address", n0.transferqualifier, token_name, 1, n1_address, "garbagechangeaddress")
    ...
    def tagging(self):
        ...
        yona_change_address = n0.getnewaddress()
        token_change_address = n0.getnewaddress()
        n0.addtagtoaddress(tag, yona_change_address)
        n0.addtagtoaddress(tag, token_change_address)
        n0.generate(1)
        assert_raises_rpc_error(-8, "bad-txns-null-verifier-address-failed-verification", n0.transfer, token_name, 100, address, "", 0, yona_change_address, token_change_address)
        n0.removetagfromaddress(tag, yona_change_address)
        n0.removetagfromaddress(tag, token_change_address)
        n0.generate(1)
        ##

        assert_raises_rpc_error(None, "Invalid Yona address", n0.addtagtoaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.addtagtoaddress, tag, address, "garbagechangeaddress")
        ...
        # special case: make sure transfer fails if the token change address isn't verified (even if the yona change address is)
        yona_change_address = n0.getnewaddress()
        token_change_address = n0.getnewaddress()
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, token_name, 100, address, "", 0, yona_change_address, token_change_address)
        n0.addtagtoaddress(tag, yona_change_address)
        n0.generate(1)
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, token_name, 100, address, "", 0, yona_change_address, token_change_address)
        n0.removetagfromaddress(tag, yona_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.removetagfromaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.removetagfromaddress, tag, address, "garbagechangeaddress")
    ...
    def freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.freezeaddress, token_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.freezeaddress, token_name, address, "garbagechangeaddress")

        n0.freezeaddress(token_name, address, yona_change_address)
        n0.generate(1)

        assert_raises_rpc_error(-32600, "freeze-address-when-already-frozen", n0.freezeaddress, token_name, address, yona_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Yona address", n0.unfreezeaddress, token_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.unfreezeaddress, token_name, address, "garbagechangeaddress")

        n0.unfreezeaddress(token_name, address, yona_change_address)
        n0.generate(1)

        assert_raises_rpc_error(-32600, "unfreeze-address-when-not-frozen", n0.unfreezeaddress, token_name, address, yona_change_address)
    ...
    def global_freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.freezerestrictedtoken, token_name, "garbagechangeaddress")

        n0.freezerestrictedtoken(token_name, yona_change_address)  # Can only freeze once!
        assert_raises_rpc_error(-26, "Freezing transaction already in mempool", n0.freezerestrictedtoken, token_name, yona_change_address)
        n0.generate(1)
        assert_raises_rpc_error(None, "global-freeze-when-already-frozen", n0.freezerestrictedtoken, token_name, yona_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Yona change address", n0.unfreezerestrictedtoken, token_name, "garbagechangeaddress")

        n0.unfreezerestrictedtoken(token_name, yona_change_address)  # Can only un-freeze once!
        assert_raises_rpc_error(-26, "Unfreezing transaction already in mempool", n0.unfreezerestrictedtoken, token_name, yona_change_address)
        n0.generate(1)
        assert_raises_rpc_error(None, "global-unfreeze-when-not-frozen", n0.unfreezerestrictedtoken, token_name, yona_change_address)
