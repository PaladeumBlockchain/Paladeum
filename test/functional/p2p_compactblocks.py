...
# TestNode: A peer we use to send messages to yonad, and store responses.
...
class CompactBlocksTest(YonaTestFramework):
    ...
    # This test actually causes yonad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that yonad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for yonad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # yonad will not send blocktxn responses for blocks whose height is
