...
# TestNode: A peer we use to send messages to paladeumd, and store responses.
...
class CompactBlocksTest(PaladeumTestFramework):
    ...
    # This test actually causes paladeumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that paladeumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for paladeumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # paladeumd will not send blocktxn responses for blocks whose height is
