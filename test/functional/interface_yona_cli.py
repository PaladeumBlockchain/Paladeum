...
class TestYonaCli(YonaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `yona-cli getinfo`")
        ...
        self.log.info("Compare responses from `yona-cli -getinfo` and the RPCs data is retrieved from.")
