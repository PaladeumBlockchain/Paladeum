...
class WalletTest(PaladeumTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PLD from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PLD with subtract fee from amount
        ...
        # Sendmany 10 PLD with subtract fee from amount
