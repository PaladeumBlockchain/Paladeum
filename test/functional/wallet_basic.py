...
class WalletTest(AkilaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 AKILA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 AKILA with subtract fee from amount
        ...
        # Sendmany 10 AKILA with subtract fee from amount
