...
class WalletTest(YonaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 YONA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 YONA with subtract fee from amount
        ...
        # Sendmany 10 YONA with subtract fee from amount
