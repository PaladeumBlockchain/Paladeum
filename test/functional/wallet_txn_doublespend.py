...
class TxnMallTest(AkilaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AKILA:
        ...
        # First: use raw transaction API to send 1240 AKILA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AKILA coin each
        ...
        # Node0's balance should be starting balance, plus 50AKILA for another
        ...
        # Node0's total balance should be starting balance, plus 100AKILA for 
