...
class TxnMallTest(YonaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 YONA:
        ...
        # First: use raw transaction API to send 1240 YONA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 YONA coin each
        ...
        # Node0's balance should be starting balance, plus 50YONA for another
        ...
        # Node0's total balance should be starting balance, plus 100YONA for 
