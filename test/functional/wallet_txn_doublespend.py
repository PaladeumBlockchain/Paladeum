...
class TxnMallTest(PaladeumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PLD:
        ...
        # First: use raw transaction API to send 1240 PLD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PLD coin each
        ...
        # Node0's balance should be starting balance, plus 50PLD for another
        ...
        # Node0's total balance should be starting balance, plus 100PLD for 
