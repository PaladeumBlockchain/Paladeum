...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the YonaTestFramework
    pass

class ExampleTest(YonaTestFramework):
    # Each functional test is a subclass of the YonaTestFramework class.
    ...
    def custom_method(self):
        ...
        YonaTestFramework class so other tests can use it."""
