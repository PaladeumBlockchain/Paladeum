...
By default, paladeumd will dump mempool on shutdown and
...
class MempoolPersistTest(PaladeumTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give paladeumd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent paladeumd from writing mempool.dat to disk. Verify that `savemempool` fails")
