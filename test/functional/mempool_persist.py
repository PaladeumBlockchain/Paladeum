...
By default, yonad will dump mempool on shutdown and
...
class MempoolPersistTest(YonaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give yonad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent yonad from writing mempool.dat to disk. Verify that `savemempool` fails")
