...
By default, akilad will dump mempool on shutdown and
...
class MempoolPersistTest(AkilaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give akilad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent akilad from writing mempool.dat to disk. Verify that `savemempool` fails")
