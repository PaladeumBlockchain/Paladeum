...
class AssetTest(YonaTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="YONA*", verbose=False, count=2, start=-2)
        ...
        yona_assets = n0.listassets(asset="YONA*", verbose=False, count=2, start=-2)
        assert_equal(len(yona_assets), 2)
        assert_equal(yona_assets[0], "YONA2")
        assert_equal(yona_assets[1], "YONA3")
        self.sync_all()
