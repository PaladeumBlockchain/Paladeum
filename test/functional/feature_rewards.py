...
class RewardsTest(YonaTestFramework):
    ...
    # - verify that each one receives the expected amount of reward YONA
    def basic_test_yona(self):
        ...
        self.log.info("Verifying YONA holdings after payout")
    ...
    def payout_before_minimum_height_is_reached(self):
        ...
        assert_raises_rpc_error(-32600,
                                ...
                                n0.distributereward, "STOCK6", tgt_block_height, "YONA", 2000, owner_addr0)
    ...
    def payout_custom_height_set_with_low_funds(self):
        ...
        n1.distributereward("STOCK7", tgt_block_height, "YONA", 2000, owner_addr0)

        n1.generate(2)
        self.sync_all()

        assert_equal(n1.getdistributestatus("STOCK7", tgt_block_height, "YONA", 2000, owner_addr0)['Status'], 3)
