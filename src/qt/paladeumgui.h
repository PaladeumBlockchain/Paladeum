...
#ifndef PLB_QT_PLBGUI_H
#define PLB_QT_PLBGUI_H
...
/**
  Paladeum GUI main class. This class represents the main window of the Paladeum UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PaladeumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PaladeumGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PaladeumGUI();
