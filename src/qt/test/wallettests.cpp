...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AkilaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_akila-qt -platform xcb      # Linux
//     src/qt/test/test_akila-qt -platform windows  # Windows
//     src/qt/test/test_akila-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AkilaUnits::formatWithUnit(unit, balance, false, AkilaUnits::separatorAlways);
    ...
    // Amount input
    AkilaAmountField* amountInput = receiveCoinsDialog.findChild<AkilaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: akila:")) != -1);
