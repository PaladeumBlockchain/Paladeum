...
#include "qt/paladeumamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PaladeumAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_paladeum-qt -platform xcb      # Linux
//     src/qt/test/test_paladeum-qt -platform windows  # Windows
//     src/qt/test/test_paladeum-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PaladeumUnits::formatWithUnit(unit, balance, false, PaladeumUnits::separatorAlways);
    ...
    // Amount input
    PaladeumAmountField* amountInput = receiveCoinsDialog.findChild<PaladeumAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: paladeum:")) != -1);
