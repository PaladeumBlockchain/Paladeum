...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<YonaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_yona-qt -platform xcb      # Linux
//     src/qt/test/test_yona-qt -platform windows  # Windows
//     src/qt/test/test_yona-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = YonaUnits::formatWithUnit(unit, balance, false, YonaUnits::separatorAlways);
    ...
    // Amount input
    YonaAmountField* amountInput = receiveCoinsDialog.findChild<YonaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: yona:")) != -1);
