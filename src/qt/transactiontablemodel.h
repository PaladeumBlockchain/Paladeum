...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PaladeumUnits::SeparatorStyle separators=PaladeumUnits::separatorStandard) const;
