...
#ifndef YONA_QT_GUIUTIL_H
#define YONA_QT_GUIUTIL_H
...
/** Utility functions used by the Yona Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "yona:" URI into recipient object, return true on successful parsing
