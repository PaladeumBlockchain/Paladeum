...
#ifndef PLD_QT_CREATETOKENDIALOG_H
#define PLD_QT_CREATETOKENDIALOG_H
...
public:
    ...
    void updateTokenListForRestrictedIssuance();
    void updateTokenListForSubQualifierIssuance();
    void restrictedTokenSelected();
    void restrictedTokenNotSelected();
...
#endif // PLD_QT_CREATETOKENDIALOG_H
