...
void AssetControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    l2->setText(YonaUnits::formatWithCustomName(QString::fromStdString(strAssetName), nAssetAmount));        // Amount
    ...
    l8->setText(YonaUnits::formatWithCustomName(QString::fromStdString(strAssetName), nChange));        // Change
    if (nPayFee > 0)
    {
