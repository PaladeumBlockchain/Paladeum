...
#ifndef AKILA_QT_AKILAUNITS_H
#define AKILA_QT_AKILAUNITS_H
...
/** Akila unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AkilaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AkilaUnits(QObject *parent);
...
typedef AkilaUnits::Unit AkilaUnit;

#endif // AKILA_QT_AKILAUNITS_H
