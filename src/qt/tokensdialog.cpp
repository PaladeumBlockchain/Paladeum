...
void TokensDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        connect(ui->groupFee, &QButtonGroup::idClicked, this, &TokensDialog::updateFeeSectionControls);
#else
...
void TokensDialog::setupTokenControlFrame(const PlatformStyle *platformStyle)
{
    ...
    ui->frameTokenControl->setGraphicsEffect(GUIUtil::getShadowEffect());
...
void TokensDialog::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& stake,
                                 const CAmount& watchBalance, const CAmount& watchUnconfirmedBalance, const CAmount& watchImmatureBalance,
                                 const CAmount& watchOnlyStake, const CAmount& lockedBalance, const CAmount& offlineBalance)
{
...
void TokensDialog::tokenControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelTokenControlChangeLabel->setText(tr("Warning: Invalid Yona address"));
        }
        else // Valid address
        {
