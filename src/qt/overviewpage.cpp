...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelUnconfirmed->setText(YonaUnits::formatWithUnit(unit, unconfirmedBalance, false, YonaUnits::separatorAlways));
    ...
    ui->labelWatchTotal->setText(YonaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, YonaUnits::separatorAlways));
