...
#include "config/akila-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAkilaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AkilaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAkilaURI(info));
}
