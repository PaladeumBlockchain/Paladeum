...
#include "config/yona-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatYonaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + YonaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatYonaURI(info));
}
