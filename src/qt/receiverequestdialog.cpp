...
#include "config/paladeum-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPaladeumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PaladeumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPaladeumURI(info));
}
