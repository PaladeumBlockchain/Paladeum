...
void CreateTokenDialog::setUpValues()
{
    ...
    QStringList list;
    list.append(tr("Main Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::ROOT)) + ")");
    list.append(tr("Sub Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::SUB)) + ")");
    list.append(tr("Unique Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::UNIQUE)) + ")");
    list.append(tr("Messaging Channel Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::MSGCHANNEL)) + ")");
    list.append(tr("Qualifier Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::QUALIFIER)) + ")");
    list.append(tr("Sub Qualifier Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::SUB_QUALIFIER)) + ")");
    list.append(tr("Restricted Token") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::RESTRICTED)) + ")");
    list.append(tr("Username") + " (" + PaladeumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(KnownTokenType::USERNAME)) + ")");
...
void CreateTokenDialog::onCreateTokenClicked()
{
    ...
    QString amount = "<b>" + QString::fromStdString(ValueFromAmountString(GetBurnAmount(type), 8)) + " PLD";
    amount.append("</b>");
