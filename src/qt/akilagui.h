...
#ifndef AKILA_QT_AKILAGUI_H
#define AKILA_QT_AKILAGUI_H
...
/**
  Akila GUI main class. This class represents the main window of the Akila UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AkilaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AkilaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AkilaGUI();
