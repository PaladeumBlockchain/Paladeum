...
#ifndef YONA_QT_YONAUNITS_H
#define YONA_QT_YONAUNITS_H
...
/** Yona unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class YonaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit YonaUnits(QObject *parent);
...
typedef YonaUnits::Unit YonaUnit;

#endif // YONA_QT_YONAUNITS_H
