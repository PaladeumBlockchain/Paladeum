...
#ifndef YONA_QT_YONAGUI_H
#define YONA_QT_YONAGUI_H
...
/**
  Yona GUI main class. This class represents the main window of the Yona UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YonaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit YonaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~YonaGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a yona wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
