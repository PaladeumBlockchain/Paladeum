...
#ifndef YONA_TEST_SCRIPTNUM10_H
#define YONA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Yona Core 0.10.0, for cross-comparison.
 */
public:
