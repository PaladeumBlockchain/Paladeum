...
#ifndef YONA_VALIDATION_H
#define YONA_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for yona, with 1 minutes block intervals?
...
bool CheckBlock(const CBlock& block, CValidationState& state, const uint256& hash, const Consensus::Params& consensusParams, bool fCheckPOW = false, bool fCheckMerkleRoot = true, bool fDBCheck = false, bool fCheckSig = true);
...
/** Check whether OfflineStaking has been activated. */
