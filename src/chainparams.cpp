...
//        consensus.vDeployments[Consensus::DEPLOYMENT_P2SH_ASSETS].nOverrideRuleChangeActivationThreshold = 1411; // Approx 70% of 2016
        ...
        vSeeds.emplace_back("seed-yona.bitactivate.com", false);
        vSeeds.emplace_back("seed-yona.yonacoin.com", false);
        vSeeds.emplace_back("seed-yona.yonacoin.org", false);
        ...
        // Yona BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Yona chain
...
//        /////////////////////////////////////////////////////////////////
        ...
        vSeeds.emplace_back("seed-testnet-yona.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-yona.yonacoin.com", false);
        vSeeds.emplace_back("seed-testnet-yona.yonacoin.org", false);
