...
#ifndef YONACOIN_ASSET_PROTOCOL_H
#define YONACOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_YONA_ASSET YONAQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_YONA_ASSET YONAO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_YONA_ASSET YONAR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_YONA_ASSET YONAT
...
#endif //YONACOIN_ASSET_PROTOCOL_H
