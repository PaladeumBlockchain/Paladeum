...
CAmount AmountFromValue(const UniValue& value, bool p_isPLB)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Paladeum server stopping";
}
...
{
    return "> paladeum-cli " + methodname + " " + args + "\n";
}
