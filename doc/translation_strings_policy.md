...
This document provides guidelines for internationalization of the Yona Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `yona_en.ts` remains unchanged.
