...
Below are some notes on how to build Yona Core for Windows.
...
way. This will install to `c:\workspace\yona`, for example:

    make install DESTDIR=/mnt/c/workspace/yona
