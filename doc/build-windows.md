...
Below are some notes on how to build Paladeum Core for Windows.
...
way. This will install to `c:\workspace\paladeum`, for example:

    make install DESTDIR=/mnt/c/workspace/paladeum
