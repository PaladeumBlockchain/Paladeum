...
Below are some notes on how to build Akila Core for Windows.
...
way. This will install to `c:\workspace\akila`, for example:

    make install DESTDIR=/mnt/c/workspace/akila
