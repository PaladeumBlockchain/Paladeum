...
The Paladeum Doxygen documentation can be generated by running `make docs` from the top-level 
...
be sent upstream but bugfixes may also be prudent to PR against Paladeum so that they can be integrated
