Akila Core version *2.1.0* is now available!!
==============

  <https://github.com/AkilaProject/Akilacoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/AkilaProject/Akilacoin/commits/release_2.1.0>
