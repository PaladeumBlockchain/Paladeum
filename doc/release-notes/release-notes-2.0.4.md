Paladeum Core version *2.0.4.0* is now available!!
==============

  <https://github.com/PaladeumProject/Paladeum/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/PaladeumProject/Paladeum/commits/release_2.0.4>
