...
We'll need to find 3 UTXOs to use as inputs.  Andy's apples, Barb's bananas and some Yona to pay the network fee (Andy will pay).
...
We'll be using 5 new Yonacoin addresses:

Andy's Yona change address:
