...
"""
    ...
    Paladeum should be started with the command line arguments:
        paladeumd -testnet -daemon \
...
print("Getting Paladeumcoin msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND PLB issuance at " + str(pos))
				print("After PLB: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND PLB something at " + str(pos))
			start += pos+8
			print(astr)
