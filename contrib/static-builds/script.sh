...
find ${DISTNAME}/bin -type f -executable -exec ../akilacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../akilacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/akilacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/akilacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
