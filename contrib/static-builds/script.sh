...
find ${DISTNAME}/bin -type f -executable -exec ../yonacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../yonacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/yonacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/yonacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
