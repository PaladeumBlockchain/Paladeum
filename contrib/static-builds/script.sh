...
rm -rf ~/paladeumcoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../paladeumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../paladeumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/paladeumcoin/temp
cd ~/paladeumcoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/paladeumcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/paladeumcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
